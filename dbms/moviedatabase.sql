...
--which are the movies that are returned 
select M.movie_id,movie_title, rent_status,member_id from Movies M inner join RentalDetails RD on M.movie_id=RD.movie_id  where rent_status='Returned'
