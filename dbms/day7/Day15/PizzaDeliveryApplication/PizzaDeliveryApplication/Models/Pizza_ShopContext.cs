...
{
    public partial class Pizza_ShopContext : DbContext
    {
        public Pizza_ShopContext()
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=KANINI-LTP-476\\SQLSERVER2021ACH;Integrated Security=true;Initial catalog=Pizza_Shop");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ToppingDetail>(entity =>
            {
                entity.HasKey(e => new { e.DetailsId, e.OrderId })
                    .HasName("PK__Topping___C0BC761B03E2B2AD");
                ...
                entity.HasOne(d => d.Details)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Topping_D__Detai__440B1D61");

                entity.HasOne(d => d.Order)
                    .WithMany(p => p.ToppingDetails)
                    .HasForeignKey(d => d.OrderId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Topping_D__Order__4316F928");

                entity.HasOne(d => d.Toppings)
                    .WithMany(p => p.ToppingDetails)
                    .HasForeignKey(d => d.ToppingsId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Topping_D__Toppi__44FF419A");
            });
